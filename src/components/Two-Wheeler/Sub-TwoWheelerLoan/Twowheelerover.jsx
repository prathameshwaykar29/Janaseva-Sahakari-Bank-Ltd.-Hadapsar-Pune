...
const twoWheeler_loanHighlights = [
  [<FaPercentage />, "9.85% – 10.15%", "Rate of Interest (CIBIL Based)"],
  [<FaRupeeSign />, "Rs. 5.00 Lakh", "Maximum Loan Limit"],
  [<FaPercentage />, "10% of On-Road Cost", "Margin"],
  [<FaCalendarAlt />, "60 Months", "Loan Period"],
  [<FaCoins />, "2.50% (Max Rs.3,000)", "Shares"],
  [<AiOutlineFileDone />, "Rs. 500 + GST", "Processing Fee"],
  [<FaUserShield />, "NA", "Guarantor"],
];



export default function Twowheelerover() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {twoWheeler_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
