...
const homeDecore_loanDocsData = {
  General: [
    ...
    },
    {
      ...
      items: [
        { name: "Registered Leave & License / Rent Agreement", note: "Mandatory" },
        { name: "Last 12 Months Bank Statement showing rental income", note: "Mandatory" },
        ...
        { name: "Proof of Source of Margin Money", note: "Required" },
      ],
    },
  ],
};
...
export default function Rentdoc() {
