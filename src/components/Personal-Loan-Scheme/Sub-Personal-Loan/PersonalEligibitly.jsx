...
const gharkul_eligibilityData = {
  ...
  title: "Personal Loan Eligibility",
    items: [
      ...
      ["Loan Purpose", "Personal Reason / Repayment of Debt / Any reason other than financial speculation"],
      ["Maximum Loan", "Rs. 5 Lakh"],
      ["Interest Rate", "CIBIL 700+: 12.00% | CIBIL 650-699: 13.00%"],
      ["Margin", "NA"],
...
export default function PersonalEligibitly() {
  return (
