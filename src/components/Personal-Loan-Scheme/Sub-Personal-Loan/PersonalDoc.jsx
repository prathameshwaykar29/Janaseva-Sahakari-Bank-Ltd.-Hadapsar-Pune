  ...
  General: [
    {
      ...
      items: [
        { name: "Photographs – 3 Copies (Borrower & 2 Guarantors)", note: "Mandatory" },
        ...
        { name: "Last 3 Months Salary Slips", note: "Required" },
        { name: "Last 12 Months Bank Statement", note: "Mandatory" },
        { name: "IT Returns (Last 2 years)", note: "Required" },
        { name: "Employment Identity Card", note: "Required" },
