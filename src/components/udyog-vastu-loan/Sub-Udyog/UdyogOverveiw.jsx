...
const loanHighlights = [
  [<FaPercentage />, "A Rating 9.50% Other-10.00%", "Rate of Interest"],
  [<FaRupeeSign />, "upto Exposure ", "Maximum Loan Limit"],
  [<CiCreditCard1  />, "15 % for purchase 20% for Construction (incl. Stamp duty and Registration cost)", "Margin"],
  [<FaCalendarAlt />, "120 M (including moratorium 18 months)", "Loan Period"],
  [<FaCoins />, "2.50%", "Shares"],
  [<FaFileInvoiceDollar />, "1.00%", "Processing Fee"],
  [<FaUserFriends />, "1 Required", "Guarantor"],
];

export default function UdyogOverveiw() {
  return (
    <CardSection>
