...
import Unsecuredover from "./Unsecuredover.jsx";
import UnsecuredBenifits from "./UnsecuredBenifits.jsx";
import UnsecuredEiligibilty from "./UnsecuredEiligibilty.jsx";
import Unsecureddoc from "./Unsecureddoc.jsx";
import Unsecuredfaq from "./Unsecuredfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Unsecuredover />,
  "Features & Benefits": <UnsecuredBenifits />,
  "Eligibility": <UnsecuredEiligibilty />,
  "Documents": <Unsecureddoc />,
  "FAQs": <Unsecuredfaq />
};

export default function MainUnsecured() {
