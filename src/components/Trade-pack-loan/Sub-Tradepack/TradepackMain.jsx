...
import TradepackOverveiw from "./TradepackOverveiw.jsx";
import Tradepackfaqs from "./Tradepackfaqs.jsx";
import TradepackDocument from "./TradepackDocument.jsx";
import TradepackEligibility from "./TradepackEligibility.jsx";
import TradepackBenifits from "./TradepackBenifits.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <TradepackOverveiw />,
  "Features & Benefits": <TradepackBenifits />,
  "Eligibility": <TradepackEligibility />,
  "Documents": <TradepackDocument />,
  "FAQs": <Tradepackfaqs />
};

export default function TradepackMain() {
