...
const machinery_faqs = [
  { q: "What is the Machinery Loan?", a: "A loan for purchase of new or used machinery for business purposes." },
  { q: "What is the interest rate?", a: "10.00% per annum." },
  { q: "What margin is required?", a: "25% for new machinery and 40% for old / used machinery." },
  { q: "What is the repayment period?", a: "60 to 120 months depending on loan amount and machinery type." },
  { q: "Is a guarantor required?", a: "Yes, 1 guarantor is required." },
  { q: "Is collateral required?", a: "For MSME: above 10 lakh – 50%. For regular: above Rs. 5 lakh – 50%." },
];
...
export default function MachineryLoanFaq() {
