  ...
  General: [
    {
      ...
      items: [
        ...
        { name: "Shop Act License / Business Registration / Udyog Aadhaar", note: "Mandatory" },
        { name: "GST Registration Certificate", note: "Wherever Applicable" },
      ],
    },
    {
      cat: "Financial & Machinery Documents",
      icon: HiDocumentText,
      items: [
        ...
        { name: "Quotation / Invoice from Machinery Supplier", note: "Mandatory" },
        { name: "Details of Existing Machinery (Make, Model, Capacity)", note: "Required" },
        { name: "Machinery Valuation Report (for used machinery)", note: "Mandatory for Old" },
...
export default function MachineryLoanDoc() {
