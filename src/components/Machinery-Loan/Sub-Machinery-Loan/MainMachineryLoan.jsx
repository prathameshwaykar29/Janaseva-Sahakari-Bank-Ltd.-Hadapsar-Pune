...
import MachineryLoanover from "./MachineryLoanover.jsx";
import MachineryLoanBenefit from "./MachineryLoanBenefit.jsx";
import MachineryLoanEligibilty from "./MachineryLoanEligibilty.jsx";
import MachineryLoanDoc from "./MachineryLoanDoc.jsx";
import MachineryLoanFaq from "./MachineryLoanFaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <MachineryLoanover />,
  "Features & Benefits": <MachineryLoanBenefit />,
  "Eligibility": <MachineryLoanEligibilty />,
  "Documents": <MachineryLoanDoc />,
  "FAQs": <MachineryLoanFaq />
};

export default function MainMachineryLoan() {
