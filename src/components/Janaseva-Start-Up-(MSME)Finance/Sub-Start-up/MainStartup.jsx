...
import StartupOver from "./StartupOver.jsx";
import StartupBenefits from "./StartupBenefits.jsx";
import StartupEligibilty from "./StartupEligibilty.jsx";
import StartupDoc from "./StartupDoc.jsx";
import Startupfaq from "./Startupfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <StartupOver />,
  "Features & Benefits": <StartupBenefits />,
  "Eligibility": <StartupEligibilty />,
  "Documents": <StartupDoc />,
  "FAQs": <Startupfaq />
};

export default function MainStartup() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 py-10 max-w-[1200px] mx-auto">
        ...
        <div className="w-full lg:w-auto">
          <CalculatorSidebar
            ...
            tenures={[12, 24, 40 ,80,120]} // Tenures in months
