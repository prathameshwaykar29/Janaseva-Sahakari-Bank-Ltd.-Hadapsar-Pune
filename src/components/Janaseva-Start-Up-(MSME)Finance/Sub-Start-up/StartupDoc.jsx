...
const homeDecore_loanDocsData = {
  General: [
    ...
    },
    {
      ...
      icon: HiDocumentText,
      items: [
        { name: "Projected Balance Sheet with CMA Data", note: "Mandatory" },
        { name: "Proof of Start-up / New Business", note: "Mandatory" },
        { name: "Quotation / Estimate for Machinery / Shed", note: "Required" },
        { name: "Land / Plot Documents (if applicable)", note: "Wherever Applicable" },
...
export default function StartupDoc() {
