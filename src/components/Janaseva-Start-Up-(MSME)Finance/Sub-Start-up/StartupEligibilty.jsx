...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Janaseva Start Up (MSME) Finance Eligibility",
    items: [
      ["Applicant Type", "Any Person / Legal Constitution having regular source of income – For New Customers Only"],
      ["Loan Purpose", "Working Capital, Purchase of business assets, Industrial plot/shed, Factory shed, Machinery"],
      ["Maximum Loan", "Upto Exposure Limit"],
      ["Interest Rate", "10.00% per annum"],
      ["Margin", "15%"],
      ["Loan Period", "CC – 12 M | TL – 84 M | Shed – 120 M"],
...
export default function StartupEligibilty() {
  return (
