...
export default function Heilover() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {hospital_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
