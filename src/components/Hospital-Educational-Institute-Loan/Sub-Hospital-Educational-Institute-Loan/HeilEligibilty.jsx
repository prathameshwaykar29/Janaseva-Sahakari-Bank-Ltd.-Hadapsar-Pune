...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Hospital / Educational Institute Loan Eligibility",
    items: [
      ["Applicant Type", "Specialty / Super Specialty Hospitals, Nursing Homes, Pathology Labs, Diagnostic Centers, Dental Clinics, IVF Centers, Educational Institutes etc."],
      ["Loan Purpose", "Hospital construction, Land Purchase, Medical Equipment, School / College construction, Educational Materials"],
      ["Maximum Loan", "Upto Exposure Limit"],
      ["Interest Rate", "10.00% per annum"],
      ["Margin", "25%"],
      ["Loan Period", "Property – 120 Months | Other Purpose – 84 Months"],
      ["Guarantor", "2 Required"],
      ["Shares", "2.50%"],
      ["Processing Fee", "1.00%"],
      ["Collateral Security", "Min 50% to 100% (case to case basis)"],
    ],
...
export default function HeilEligibilty() {
  return (
