...
import Heilover from "./Heilover.jsx";
import HeilBenefits from "./HeilBenefits.jsx";
import HeilEligibilty from "./HeilEligibilty.jsx";
import HeilDoc from "./HeilDoc.jsx";
import Heilfaq from "./Heilfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Heilover />,
  "Features & Benefits": <HeilBenefits />,
  "Eligibility": <HeilEligibilty />,
  "Documents": <HeilDoc />,
  "FAQs": <Heilfaq />
};

export default function MainHeil() {
