...
const translations = {
  en: {
    ...
    subtitle: "For Hospitals & Schools",
    desc: "Quick and flexible financing to set up or expand hospitals, schools, and educational institutions with easy options.",
    applyBtn: "Apply Now",
    calcBtn: "Calculate EMI",
    loanName: "Hospital/Educational Institute Loan ",
  },
  mr: {
    title: "संस्था कर्ज",
    subtitle: "रुग्णालये आणि शाळांसाठी",
    desc: "रुग्णालये, शाळा आणि शैक्षणिक संस्था सुरू करण्यासाठी किंवा विस्तारासाठी जलद व लवचिक कर्ज सुविधा.",
    applyBtn: "अर्ज करा",
    calcBtn: "ईएमआय मोजा",
    loanName: "Hospital/Educational Institute Loan ",
  },
      ...
      <div className="max-w-[1200px] mx-auto px-4 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-14">
          ...
          <div className="relative flex justify-center">
            <img
              src={bikeImg}
              alt="Hospital-Educational-Institute-Loan"
