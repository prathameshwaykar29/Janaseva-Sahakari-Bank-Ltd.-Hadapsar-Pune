...
const homeDecore_loanDocsData = {
  General: [
    ...
    {
      icon: HiDocumentText,
       cat: "Solar & Financial Documents",
      items: [
        { name: "Quotation from MNRE / State-approved Solar Vendor", note: "Mandatory" },
        { name: "Property / Terrace Ownership Proof (for rooftop installation)", note: "Mandatory" },
        { name: "Electricity Bill (Last 3 months)", note: "Required" },
        { name: "Last 12 Months Bank Statement", note: "Mandatory" },
        { name: "IT Returns / Salary Slips (Last 3 years)", note: "Required" },
        { name: "Proof of Source of Margin Money", note: "Mandatory" },
        { name: "Government Subsidy Approval Letter (if applicable)", note: "Wherever Applicable" },
      ],
...
export default function Solardoc() {
