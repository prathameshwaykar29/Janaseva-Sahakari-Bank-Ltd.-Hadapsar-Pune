...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Janaseva Solar Scheme Eligibility",
    items: [
      ["Applicant Type", "Any Person / Legal Constitution having regular source of income"],
      ["Loan Purpose", "Solar System installation for Personal use / Business purpose"],
      ["Maximum Loan", "Personal – Rs. 25 Lakh | Business – Rs. 50 Lakh"],
      ...
      ["Shares", "2.50%"],
      ["Processing Fee", "1.00%"],
      ["Collateral Security", "Regular: Above Rs. 5 Lakh – 50%"],
    ],
...
export default function SolarEligibilty() {
  return (
