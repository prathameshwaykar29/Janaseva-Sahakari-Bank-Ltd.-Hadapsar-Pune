...
import bikeImg from "../../../assets/images/Loan/solar.png";

const translations = {
  en: {
    title: "Solar Scheme",
    subtitle: "Go Green & Save",
    desc: "Affordable financing for installing solar panels and renewable energy solutions for homes and businesses.",
    applyBtn: "Apply Now",
    calcBtn: "Calculate EMI",
    loanName: "Janaseva Solar Scheme",
  },
  mr: {
    title: "सौर ऊर्जा योजना",
    subtitle: "हरित ऊर्जा वापरा आणि बचत करा",
    desc: "घर आणि व्यवसायासाठी सोलार पॅनेल व नवीकरणीय ऊर्जा उपायांसाठी परवडणारी कर्ज सुविधा.",
    applyBtn: "अर्ज करा",
    calcBtn: "ईएमआय मोजा",
    loanName: "Janaseva Solar Scheme",
  },
