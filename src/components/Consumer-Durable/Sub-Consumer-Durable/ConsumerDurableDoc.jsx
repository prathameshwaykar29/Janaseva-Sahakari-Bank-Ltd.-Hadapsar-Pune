  ...
  General: [
    {
      ...
      items: [
        ...
        { name: "List of Consumer Durables to be purchased", note: "Mandatory" },
        { name: "Quotation from Dealer / Vendor", note: "Mandatory" },
        { name: "Booking / Advance Payment Receipt", note: "If Applicable" },
      ],
...
export default function ConsumerDurableDoc() {
