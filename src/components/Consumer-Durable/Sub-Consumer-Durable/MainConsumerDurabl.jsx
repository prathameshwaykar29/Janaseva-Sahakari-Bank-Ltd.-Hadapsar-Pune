...
import ConsumerDurableover from "./ConsumerDurableover.jsx";
import ConsumerDurableBenefir from "./ConsumerDurableBenefir.jsx";
import ConsumerDurableEligibilty from "./ConsumerDurableEligibilty.jsx";
import ConsumerDurableDoc from "./ConsumerDurableDoc.jsx";
import ConsumerDurableFaq from "./ConsumerDurableFaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <ConsumerDurableover />,
  "Features & Benefits": <ConsumerDurableBenefir />,
  "Eligibility": <ConsumerDurableEligibilty />,
  "Documents": <ConsumerDurableDoc />,
  "FAQs": <ConsumerDurableFaq />
};

export default function MainConsumerDurable() {
