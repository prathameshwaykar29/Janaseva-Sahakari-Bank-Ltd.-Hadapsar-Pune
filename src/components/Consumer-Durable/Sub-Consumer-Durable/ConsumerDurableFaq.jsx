...
const consumerDurable_faqs = [
  { q: "What can I purchase with this loan?", a: "Consumer durables, electronic equipment, furniture, and household goods." },
...
export default function ConsumerDurableFaq() {
  ...
  return (
    <section className="p-6">
      ...
      <div className="flex flex-col gap-2">
        {consumerDurable_faqs.map((faq, index) => (
          <FaqItem
            key={index}
            faq={faq}
