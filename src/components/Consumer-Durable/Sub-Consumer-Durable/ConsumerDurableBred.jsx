                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-14">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-4">
                            Easy loan facility to purchase consumer durable items such as furniture, appliances, and other household essentials.
                        </p>
...
export default ConsumerDurableBred;