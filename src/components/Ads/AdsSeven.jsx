...
import goldImg from "./../../assets/images/Ads/gold.png";
import groupImg from "./../../assets/images/Ads/group.png";
import educationImg from "./../../assets/images/Ads/education.png";
...
const related = [
  ...
  {
    h: "Education Loan (Coaching)",
    p: "From 11% p.a.",
    img: educationImg,
    desc: "Finance for coaching fees.",
    accent: "bg-emerald-100 text-emerald-600",
    dot: "bg-emerald-500",
    rate: "text-emerald-600",
    border: "hover:border-emerald-400",
    bar: "from-emerald-400 to-teal-400",
    link: "/Education-loan-for-Coaching",
  },
