...
import carImg from "./../../assets/images/Ads/car-loan.jpg";
import personalImg from "./../../assets/images/Ads/Personal-loan.jpg";
import homeImg from "./../../assets/images/Ads/Home-loan.jpg";

const related = [
  {
    h: "New four Wheeler Loan",
    p: "From 8.25% p.a.",
    img: carImg,
    desc: "Drive your dream car with low EMIs and quick approvals.",
    accent: "bg-[#F8A163] text-[#f47012]",
    dot: "bg-[#f47012]",
    rate: "text-[#f47012]",
    border: "hover:border-[#f47012]",
    bar: "from-[#f47012] to-[#F68737]",
    link: "/New-four-Wheeler-Loan", // <-- Add link here
  },
  {
    h: "ProSelf Loan",
    p: "From 10.00% p.a.",
    img: personalImg,
    desc: "No collateral needed. Funds in your account within 24 hrs.",
  ...
  {
    h: "Janaseva Gharkul Top Up",
    p: "From 10% p.a.",
    img: homeImg,
    desc: "Turn the key on your dream home with flexible tenures.",
    accent: "bg-emerald-100 text-emerald-600",
    dot: "bg-emerald-500",
    rate: "text-emerald-600",
    border: "hover:border-emerald-400",
    bar: "from-emerald-400 to-teal-400",
    link: "/Janaseva-Gharkul-Top-Up",
  },
];
