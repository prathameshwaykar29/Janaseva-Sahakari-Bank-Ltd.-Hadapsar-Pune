...
// import consumerImg from "./../../assets/images/Ads/trade.png";
// import decorImg from "./../../assets/images/Ads/decor.png";
// import govtImg from "./../../assets/images/Ads/goverment.png";
...
//     p: "From 10.50% p.a.",
//     img: decorImg,
//     desc: "Upgrade your home easily.",
//     accent: "bg-[#3C62C3] text-[#1e3163]",
//     dot: "bg-[#1e3163]",
//     rate: "text-[#1e3163]",
//     border: "hover:border-[#1e3163]",
//     bar: "from-[#1e3163] to-[#263F7D]",
//     link: "/Janaseva-Home-Decore",
//   },
//   {
//     h: "Government Secured Loan",
//     p: "From 11% p.a.",
//     img: govtImg,
//     desc: "Safe loans backed by schemes.",
//     accent: "bg-emerald-100 text-emerald-600",
//     dot: "bg-emerald-500",
//     rate: "text-emerald-600",
//     border: "hover:border-emerald-400",
//     bar: "from-emerald-400 to-teal-400",
//     link: "/Government-Secured-Loan",
//   },
// ];
...
const relatedTranslations = {
  en: {
    ...
    cards: [
      { h: "Consumer Loan", p: "From 10% p.a.", desc: "Finance for daily needs." },
      { h: "Home Decor Loan", p: "From 10.50% p.a.", desc: "Upgrade your home easily." },
      { h: "Government Secured Loan", p: "From 11% p.a.", desc: "Safe loans backed by schemes." },
    ],
  },
  mr: {
    heading: "आणखी पाहा",
    ...
    cards: [
      { h: "ग्राहक कर्ज", p: "१०% प्रतिवर्षापासून", desc: "दैनंदिन गरजांसाठी वित्तपुरवठा." },
      { h: "होम डेकोर कर्ज", p: "१०.५०% प्रतिवर्षापासून", desc: "आपले घर सहजपणे सुधारा." },
      { h: "शासकीय सुरक्षित कर्ज", p: "११% प्रतिवर्षापासून", desc: "योजनांद्वारे समर्थित सुरक्षित कर्जे." },
    ],
  },
}
...
const AdsEight = () => {
  const [visible, setVisible] = useState([])
  const { lang } = useLang()
  const tr = relatedTranslations[lang]
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-3 sm:p-4 lg:p-5 bg-[#eef8ff]">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-300
                        ${r.accent} border-transparent group-hover:translate-x-1`}>
