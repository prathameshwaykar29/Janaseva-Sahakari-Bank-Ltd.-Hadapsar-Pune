...
import twoWheelerImg from "./../../assets/images/Ads/two.png";
import resaleCarImg from "./../../assets/images/Ads/resale.png";
import personalLoanImg from "./../../assets/images/Ads/personal.png";
...
const related = [
  {
    ...
    p: "From 9.85% p.a.",
    img: twoWheelerImg,
    desc: "Easy finance for bikes.",
    accent: "bg-[#F8A163] text-[#f47012]",
    dot: "bg-[#f47012]",
    rate: "text-[#f47012]",
    border: "hover:border-[#f47012]",
    bar: "from-[#f47012] to-[#F68737]",
    link: "/Two-Wheeler-Loan",
  },
  {
    h: "Resale 4-Wheeler Loan",
    p: "From 11% p.a.",
    img: resaleCarImg,
    desc: "Finance for used cars.",
    accent: "bg-[#3C62C3] text-[#1e3163]",
    dot: "bg-[#1e3163]",
    rate: "text-[#1e3163]",
    border: "hover:border-[#1e3163]",
    bar: "from-[#1e3163] to-[#263F7D]",
    link: "/Resale-4-Wheeler",
  },
  {
    h: "Personal Loan Scheme",
    p: "From 12% p.a.",
    img: personalLoanImg,
    desc: "Quick loans for personal needs.",
    accent: "bg-emerald-100 text-emerald-600",
    dot: "bg-emerald-500",
    rate: "text-emerald-600",
    border: "hover:border-emerald-400",
    bar: "from-emerald-400 to-teal-400",
    link: "/Personal-Loan-Scheme",
  },
];
const AdsSix = () => {
