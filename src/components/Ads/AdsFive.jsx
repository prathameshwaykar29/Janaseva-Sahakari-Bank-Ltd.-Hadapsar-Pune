...
import startupImg from "./../../assets/images/Ads/start.png";
import solarImg from "./../../assets/images/Ads/solar.png";
import udyogImg from "./../../assets/images/Ads/puja.png";

const related = [
  {
    h: "Start-Up (MSME) Finance",
    p: "From 10% p.a.",
    img: startupImg,
    desc: "Funding support for startups.",
    accent: "bg-[#F8A163] text-[#f47012]",
    dot: "bg-[#f47012]",
    rate: "text-[#f47012]",
    border: "hover:border-[#f47012]",
    bar: "from-[#f47012] to-[#F68737]",
    link: "/Janaseva-Start-Up-(MSME)Finance",
  },
  {
    h: "Janaseva Solar Scheme",
    p: "From 9.50% p.a.",
    img: solarImg,
    desc: "Finance for solar solutions.",
    accent: "bg-[#3C62C3] text-[#1e3163]",
    dot: "bg-[#1e3163]",
    rate: "text-[#1e3163]",
    border: "hover:border-[#1e3163]",
    bar: "from-[#1e3163] to-[#263F7D]",
    link: "/Janaseva-Solar-Scheme",
  },
  {
    h: "Udyog Vastu Loan",
    p: "From 10% p.a.",
    img: udyogImg,
    desc: "Loans for industrial property.",
    accent: "bg-emerald-100 text-emerald-600",
    dot: "bg-emerald-500",
    rate: "text-emerald-600",
    border: "hover:border-emerald-400",
    bar: "from-emerald-400 to-teal-400",
    link: "/udyog-vastu-loan",
  },
];
const AdsFive = () => {
