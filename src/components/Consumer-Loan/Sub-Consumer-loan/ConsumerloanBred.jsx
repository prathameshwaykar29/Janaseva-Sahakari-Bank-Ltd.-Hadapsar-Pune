...
import bikeImg from "../../../assets/images/Loan/Consumer-Loan.png";

const ConsumerloanBred = () => {
 ...
 {/* RIGHT SIDE */}
  ...
  Consumer Loan
  <span className="block text-[#c9a84c] text-2xl lg:text-4xl">
    For Home Furniture Needs
  </span>
</h1>

<p className="text-gray-600 text-lg leading-relaxed mb-4">
  Loan facility to purchase household furniture and other essential home items.
</p>
...
export default ConsumerloanBred;