...
import Consumerloanover from "./Consumerloanover.jsx";
import ConsumerloanBenefit from "./ConsumerloanBenefit.jsx";
import ConsumerloanEligibility from "./ConsumerloanEligibility.jsx";
import Consumerloandoc from "./Consumerloandoc.jsx";
import Consumerloanfaq from "./Consumerloanfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Consumerloanover />,
  "Features & Benefits": <ConsumerloanBenefit />,
  "Eligibility": <ConsumerloanEligibility />,
  "Documents": <Consumerloandoc />,
  "FAQs": <Consumerloanfaq />
};

export default function MainConsumerloan() {
