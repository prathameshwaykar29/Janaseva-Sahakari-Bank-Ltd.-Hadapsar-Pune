...
const housingFurniture_faqs = [
  { q: "What is the Housing Furniture Loan?", a: "A loan for purchasing furniture for your home." },
  { q: "What is the maximum loan amount?", a: "Up to Rs. 50 lakh." },
  { q: "Who is eligible?", a: "Any person or house owner with a regular source of income." },
...
export default function Consumerloanfaq() {
  ...
  return (
    <section className="p-6">
      ...
      <div className="flex flex-col gap-2">
        {housingFurniture_faqs.map((faq, index) => (
          <FaqItem
            key={index}
            faq={faq}
