...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Housing Furniture Loan Eligibility",
    items: [
      ["Applicant Type", "Any Person / Owner of House having regular source of income"],
      ["Loan Purpose", "For purchase of House Furniture"],
      ["Maximum Loan", "Rs. 50 Lakh"],
      ["Interest Rate", "10.00% per annum"],
      ["Margin", "25%"],
      ["Loan Period", "120 Months (max limited to Housing Loan tenure)"],
...
export default function ConsumerloanEligibility() {
  return (
