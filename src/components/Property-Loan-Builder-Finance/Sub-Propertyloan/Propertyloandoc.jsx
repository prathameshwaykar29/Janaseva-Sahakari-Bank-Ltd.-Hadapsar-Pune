  ...
  General: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Property Title Deed / Sale Deed", note: "Mandatory" },
        { name: "Approved Building Plan from Local Authority", note: "Mandatory" },
        { name: "Development Agreement / Builder Agreement", note: "Required" },
        { name: "Property Valuation Report by Panel Valuer", note: "Mandatory" },
        { name: "Title Clearance & Search Report by Panel Advocate", note: "Mandatory" },
        { name: "CERSAI Search Report", note: "Mandatory" },
        { name: "Property Insurance Details", note: "Required" },
...
export default function Propertyloandoc() {
