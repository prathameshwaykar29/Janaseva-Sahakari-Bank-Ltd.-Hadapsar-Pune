...
import Propertyloanover from "./Propertyloanover.jsx";
import PropertyloanEligibity from "./PropertyloanEligibity.jsx";
import Propertyloanbenefits from "./Propertyloanbenefits.jsx";
import Propertyloandoc from "./Propertyloandoc.jsx";
import Propertyloanfaq from "./Propertyloanfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Propertyloanover />,
  "Features & Benefits": <Propertyloanbenefits />,
  "Eligibility": <PropertyloanEligibity />,
  "Documents": <Propertyloandoc />,
  "FAQs": <Propertyloanfaq />
};

export default function MainPropertyloan() {
