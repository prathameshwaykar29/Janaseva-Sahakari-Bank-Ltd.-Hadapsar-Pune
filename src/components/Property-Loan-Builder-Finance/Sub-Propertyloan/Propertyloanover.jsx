...
const gharkul_loanHighlights = [
  [<FaPercentage />, "12.50%", "Rate of Interest (CIBIL Based)"],
  [<FaRupeeSign />, "upto exposure", "Maximum Loan Limit"],
  [<FaPercentage />, "50% of construction cost", "Margin"],
  [<FaCalendarAlt />, "36 to 60 M", "Loan Period"],
  [<FaCoins />, "2.5%", "Shares"],
  [<AiOutlineFileDone />, "1%", "Processing Fee"],
  [<FaUserShield />, "1", "Guarantor"],
];



export default function Propertyloanover() {
  return (
    <CardSection>
