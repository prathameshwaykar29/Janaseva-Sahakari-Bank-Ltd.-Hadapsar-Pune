...
const homeDecore_loanDocsData = {
  General: [
    ...
    {
      cat: "Financial & Property Documents",
      icon: HiDocumentText,
      items: [
        { name: "Last 3 Years IT Returns / Salary Slips", note: "Required" },
        { name: "Last 12 Months Bank Statement", note: "Mandatory" },
        { name: "Detailed Estimate of Renovation / Repair Cost", note: "Mandatory" },
        { name: "Quotation from Contractor / Vendor", note: "Required" },
        { name: "Proof of Ownership of House", note: "Mandatory" },
...
export default function DecoreDoc() {
  const [docTab] = useState("General");

  return (
    <CardSection>
      <SectionTitle>Documents & Requirements for Home Decore Loan</SectionTitle>
