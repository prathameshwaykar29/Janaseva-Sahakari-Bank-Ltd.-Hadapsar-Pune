...
const HomeDecorebred = () => {
    ...
    return (
<section className="w-full bg-gradient-to-r from-[#f8fcff] via-[#eef8ff] to-[#e3f2ff] pt-10">          <div className="max-w-[1200px] mx-auto px-4 lg:px-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-14">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-4">
                            Loan facility for home renovation, interior decoration, and furniture needs.
                        </p>
