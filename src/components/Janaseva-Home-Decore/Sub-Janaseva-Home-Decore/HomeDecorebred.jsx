...
const translations = {
  en: {
    ...
    subtitle: "Enhance Your Home Comfort",
    desc: "Loan facility for home renovation, interior decoration, and furniture needs.",
    applyBtn: "Apply Now",
    calcBtn: "Calculate EMI",
    loanName: "Janaseva Home Decore- For repairs/Addition/ Alteration",
  },
  mr: {
    title: "गृहसजावट कर्ज",
    subtitle: "आपल्या घराचा आराम वाढवा",
    desc: "घर दुरुस्ती, अंतर्गत सजावट आणि फर्निचरसाठी कर्ज सुविधा.",
    applyBtn: "अर्ज करा",
    calcBtn: "ईएमआय मोजा",
    loanName: "Janaseva Home Decore- For repairs/Addition/ Alteration ",
  },
...
const HomeDecorebred = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-r from-[#f8fcff] via-[#eef8ff] to-[#e3f2ff] pt-10">
