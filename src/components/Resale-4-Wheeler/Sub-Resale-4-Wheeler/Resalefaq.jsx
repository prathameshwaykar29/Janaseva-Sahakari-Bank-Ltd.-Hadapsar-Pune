...
const resale4W_faqs = [
  { q: "What is the Resale 4 Wheeler Loan?", a: "A loan for purchase of a second-hand / resale four-wheeler vehicle not older than 3 years." },
  { q: "What is the interest rate?", a: "11.00% per annum." },
  { q: "What margin is required?", a: "50% of the valuation amount of the vehicle." },
  { q: "What is the repayment period?", a: "36 to 60 months." },
...
export default function Resalefaq() {
