  ...
  General: [
    {
      ...
      items: [
        ...
        { name: "IT Returns / Salary Slips", note: "Required" },
        { name: "Original RC Book of Vehicle", note: "Mandatory" },
        { name: "Vehicle Valuation Report", note: "Mandatory" },
        { name: "Insurance Papers of Vehicle", note: "Required" },
        { name: "NOC from Previous Financier (if applicable)", note: "If Applicable" },
        { name: "Form No. 29 & 30 (Transfer of Ownership)", note: "Mandatory" },
      ],
    },
...
export default function ResaleDoc() {
