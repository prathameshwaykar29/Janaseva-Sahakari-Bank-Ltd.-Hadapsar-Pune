...
import Resaleover from "./Resaleover.jsx";
import ResaleBenefir from "./ResaleBenefir.jsx";
import Resaleeligibilty from "./Resaleeligibilty.jsx";
import ResaleDoc from "./ResaleDoc.jsx";
import Resalefaq from "./Resalefaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Resaleover />,
  "Features & Benefits": <ResaleBenefir />,
  "Eligibility": <Resaleeligibilty />,
  "Documents": <ResaleDoc />,
  "FAQs": <Resalefaq />
};

export default function MainResale() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 py-10 max-w-[1200px] mx-auto">
        ...
        <div className="w-full lg:w-auto">
          <CalculatorSidebar
            ...
            tenures={[30, 40, 50, 60]} // Tenures in months
