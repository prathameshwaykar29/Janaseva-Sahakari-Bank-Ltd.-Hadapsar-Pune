...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
   title: "Resale 4 Wheeler Loan Eligibility",
    items: [
      ["Applicant Type", "Any Person / Legal Constitution having regular source of income"],
      ["Loan Purpose", "Purchase of Resale 4 Wheeler Vehicle (Max 3 years old)"],
      ["Maximum Loan", "Rs. 50 Lakh"],
      ["Interest Rate", "11.00% per annum"],
      ["Margin", "50% of valuation amount"],
...
export default function Resaleeligibilty() {
  return (
