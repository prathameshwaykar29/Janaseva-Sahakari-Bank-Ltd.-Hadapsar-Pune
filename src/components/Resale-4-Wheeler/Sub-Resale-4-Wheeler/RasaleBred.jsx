...
<div className="relative flex justify-center -mb-0 lg:-mb-20">
                        <img
                            src={bikeImg}
...
<p className="text-gray-600 text-lg leading-relaxed mb-4">
    Get easy finance to purchase a pre-owned car with simple documentation and flexible EMI options.
</p>
