...
import Fdtlover from "./Fdtlover.jsx";
import FdtlBenefits from "./FdtlBenefits.jsx";
import FdtlEligibiltiy from "./FdtlEligibiltiy.jsx";
import Fdtldoc from "./Fdtldoc.jsx";
import Fdtlfaq from "./Fdtlfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Fdtlover />,
  "Features & Benefits": <FdtlBenefits />,
  "Eligibility": <FdtlEligibiltiy />,
  "Documents": <Fdtldoc />,
  "FAQs": <Fdtlfaq />
};

export default function MainFdtl() {
