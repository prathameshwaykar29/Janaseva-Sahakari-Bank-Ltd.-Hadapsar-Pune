...
const FdtlBred = () => {
    ...
    <span className="block text-[#c9a84c] text-5xl">
        Quick Loan Against Your Fixed Deposit
    </span>
</h1>

                        <p className="text-gray-600 text-lg leading-relaxed mb-4">
    Get instant loan against your Fixed Deposit without breaking it.
</p>
              ...
              <div className="text-right mt-2 sm:mt-0">
                ...
                <h3 className="text-xl font-semibold text-[#1e3163]">Up to 48 Months</h3>
                    ...
                    {/* RIGHT SIDE */}
                    <div className="relative flex justify-center -mb-0 lg:-mb-14">
                        <img
                            src={bikeImg}
