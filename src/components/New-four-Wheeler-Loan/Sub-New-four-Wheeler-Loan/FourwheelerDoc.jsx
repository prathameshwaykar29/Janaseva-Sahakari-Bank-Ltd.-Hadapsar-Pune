...
const homeDecore_loanDocsData = {
  General: [
    ...
    },
    {
      ...
      icon: HiDocumentText,
     cat: "Financial & Vehicle Documents",
      items: [
        { name: "Last 3 Years Income Tax Returns / Salary Slips", note: "Required" },
        { name: "Last 12 Months Bank Statement", note: "Mandatory" },
        { name: "Quotation from Authorised Dealer", note: "Mandatory" },
        { name: "Form No. 20 (from Dealer)", note: "Required" },
        { name: "Booking / Advance Payment Receipt", note: "Required" },
...
export default function FourwheelerDoc() {
