...
import bikeImg from "../../../assets/images/Loan/gold.png";
...
<p className="text-gray-600 text-lg leading-relaxed mb-4">
    Get instant loan by pledging your gold jewellery with minimal documentation and quick approval.
</p>
