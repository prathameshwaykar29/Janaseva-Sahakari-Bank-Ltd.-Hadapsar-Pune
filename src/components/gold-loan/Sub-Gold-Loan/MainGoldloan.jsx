...
import Goldloanover from "./Goldloanover.jsx";
import GoldloanBenefits from "./GoldloanBenefits.jsx";
import GoldEligibilty from "./GoldEligibilty.jsx";
import Goldloandoc from "./Goldloandoc.jsx";
import GoldloanFaq from "./GoldloanFaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Goldloanover />,
  "Features & Benefits": <GoldloanBenefits />,
  "Eligibility": <GoldEligibilty />,
  "Documents": <Goldloandoc />,
  "FAQs": <GoldloanFaq />
};

export default function MainGoldloan() {
