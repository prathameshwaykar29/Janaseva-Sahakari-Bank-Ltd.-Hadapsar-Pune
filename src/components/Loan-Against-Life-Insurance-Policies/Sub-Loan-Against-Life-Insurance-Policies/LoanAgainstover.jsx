...
const lic_loanHighlights = [
  [<FaPercentage />, "11.00%", "Rate of Interest"],
  [<FaRupeeSign />, "Upto Exposure Limit", "Maximum Loan Limit"],
  [<FaPercentage />, "10%", "Margin"],
  [<FaCalendarAlt />, "36 Months / Policy Due Date", "Loan Period"],
  [<FaCoins />, "2.50%", "Shares"],
  [<AiOutlineFileDone />, "Rs. 200", "Processing Fee"],
  [<FaUserShield />, "NA", "Guarantor"],
];



export default function LoanAgainstover() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {lic_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
