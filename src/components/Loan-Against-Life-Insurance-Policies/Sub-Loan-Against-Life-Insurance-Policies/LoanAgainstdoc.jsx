...
const homeDecore_loanDocsData = {
  General: [
    {
      icon: FaIdCard,
      cat: "KYC & Policy Documents",
      items: [
        { name: "Photographs – 3 Copies", note: "Mandatory" },
        { name: "PAN Card", note: "Mandatory" },
        { name: "Aadhaar Card", note: "Mandatory" },
        { name: "Original Life Insurance Policy Documents", note: "Mandatory" },
        { name: "Premium Paid Receipts", note: "Mandatory" },
        { name: "Surrender Value Certificate from Insurance Company", note: "Mandatory" },
...
export default function LoanAgainstdoc() {
