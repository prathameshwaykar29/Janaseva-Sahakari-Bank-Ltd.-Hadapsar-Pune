...
const gharkul_topup_faqs = [
  { q: "What is the Gharkul Top Up Loan?", a: "A top-up loan available on your existing housing loan for any personal or business purpose other than financial speculation." },
  { q: "What is the maximum loan amount?", a: "Up to Rs. 75 lakh." },
  { q: "What is the interest rate?", a: "10.00% per annum." },
  { q: "What margin is required?", a: "15% of the property valuation." },
  { q: "What is the repayment period?", a: "Up to 120 months, limited to the balance tenure of the existing housing loan." },
];
  ...
  return (
    <section className="p-6">
      ...
      <div className="flex flex-col gap-2">
        {gharkul_topup_faqs.map((faq, index) => (
          <FaqItem
            key={index}
            faq={faq}
