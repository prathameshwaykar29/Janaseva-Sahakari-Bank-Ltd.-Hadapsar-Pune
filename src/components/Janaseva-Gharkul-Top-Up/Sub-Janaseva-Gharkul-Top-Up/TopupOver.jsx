...
const gharkul_topup_loanHighlights = [
  [<FaPercentage />, "10.00%", "Rate of Interest"],
  [<FaRupeeSign />, "Rs. 75 Lakh", "Maximum Loan Limit"],
...
export default function TopupOver() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {gharkul_topup_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
