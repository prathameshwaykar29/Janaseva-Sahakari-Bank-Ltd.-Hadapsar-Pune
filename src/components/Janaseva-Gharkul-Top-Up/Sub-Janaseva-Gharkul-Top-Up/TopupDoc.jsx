  ...
  General: [
    {
      ...
      items: [
        ...
        { name: "Existing Housing Loan Sanction Letter & Statement", note: "Mandatory" },
        { name: "Property Valuation Report", note: "Mandatory" },
...
export default function TopupDoc() {
