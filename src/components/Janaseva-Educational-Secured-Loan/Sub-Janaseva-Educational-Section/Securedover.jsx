...
const eduSecured_loanHighlights = [
  [<FaPercentage />, "8.90% – 9.25%", "Rate of Interest"],
  [<FaRupeeSign />, "Rs. 50 Lakh", "Maximum Loan Limit"],
  [<FaPercentage />, "10% – 15%", "Margin"],
  [<FaCalendarAlt />, "144 Months", "Loan Period"],
  [<FaCoins />, "1%", "Shares"],
  [<AiOutlineFileDone />, "Rs. 1,000", "Processing Fee"],
...
export default function Securedover() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {eduSecured_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
