...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Janaseva Educational Secured Loan Eligibility",
    items: [
      ...
      ["Interest Rate", "Upto 20 Lakh: 8.90% | Above 20 Lakh: 9.25%"],
      ["Margin", "Upto 20 Lakh: 10% | Above 20 Lakh: 15%"],
      ["Loan Period", "144 Months (Course Period + 6 Months + 7 Years)"],
...
export default function SecuredEligibility() {
  return (
