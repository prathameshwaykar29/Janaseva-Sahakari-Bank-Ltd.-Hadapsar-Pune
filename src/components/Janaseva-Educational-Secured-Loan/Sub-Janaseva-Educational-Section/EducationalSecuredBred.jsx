...
const EducationalSecuredBred = () => {
    ...
    Educational Secured Loan
    <span className="block text-[#c9a84c] text-5xl">
       our Future with Education
    </span>
</h1>

<p className="text-gray-600 text-lg leading-relaxed mb-4">
    Loan facility to support higher education with security-backed funding and flexible repayment options.
</p>
