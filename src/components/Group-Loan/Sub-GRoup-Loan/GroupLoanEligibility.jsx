...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Group Loan Eligibility",
    items: [
      ["Applicant Type", "Permanent employee of Limited / Pvt Ltd / Multinational Company"],
      ["Group Requirement", "Minimum 10 members required"],
      ["Loan Purpose", "Personal Reason / Repayment of Debt"],
      ["Maximum Loan", "Rs. 5 Lakh per member"],
...
export default function GroupLoanEligibility() {
  return (
