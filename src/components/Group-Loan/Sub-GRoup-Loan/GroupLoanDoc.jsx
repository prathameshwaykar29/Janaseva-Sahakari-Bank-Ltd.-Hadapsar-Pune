...
const homeDecore_loanDocsData = {
  General: [
    {
      icon: FaIdCard,
      cat: "KYC & Employment Documents",
      items: [
        { name: "Photographs – 3 Copies (Each Member & Guarantors)", note: "Mandatory" },
        { name: "PAN Card of all members", note: "Mandatory" },
        { name: "Aadhaar Card of all members", note: "Mandatory" },
        { name: "Employment Identity Card", note: "Mandatory" },
        { name: "Salary Slips (Last 3 months)", note: "Mandatory" },
        { name: "Last 12 Months Salary A/c Bank Statement", note: "Mandatory" },
        { name: "HR Dept. Person Name & Phone Number", note: "Required" },
        { name: "Undertaking Letter from Employer", note: "Mandatory" },
        { name: "ECS Mandate", note: "Mandatory" },
...
export default function GroupLoanDoc() {
