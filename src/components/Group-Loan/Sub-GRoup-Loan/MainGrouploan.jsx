...
import Grouploanover from "./Grouploanover.jsx";
import GroupLoanEligibility from "./GroupLoanEligibility.jsx";
import GroupLoanbenefit from "./GroupLoanbenefit.jsx";
import GroupLoanDoc from "./GroupLoanDoc.jsx";
import GroupLoanFaq from "./GroupLoanFaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <Grouploanover />,
  "Features & Benefits": <GroupLoanbenefit />,
  "Eligibility": <GroupLoanEligibility />,
  "Documents": <GroupLoanDoc />,
  "FAQs": <GroupLoanFaq />
};

export default function MainGrouploan() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 py-10 max-w-[1200px] mx-auto">
        ...
        <div className="w-full lg:w-auto">
          <CalculatorSidebar
            ...
            rate={9.75}                // Interest rate: 9.50% for A-rated borrowers
          />
        </div>
      </div>
    </div>
