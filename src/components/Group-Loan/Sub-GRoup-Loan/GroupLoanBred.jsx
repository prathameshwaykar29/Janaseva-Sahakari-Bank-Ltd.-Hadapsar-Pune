...
import bikeImg from "../../../assets/images/Loan/Group-Loan.png";
...
{/* RIGHT SIDE */}
  ...
  <span className="block text-[#c9a84c] text-2xl lg:text-4xl">
    For Personal Needs & Debt Repayment
  </span>
</h1>

<p className="text-gray-600 text-lg leading-relaxed mb-4">
  Loan facility for groups to meet personal requirements, repay existing debts.
</p>
