...
//             "/3-wheeler-loan",
//             "/commercial-vehicle-loan",
//             "/udyog-vastu-loan", "/Janaseva-Solar-Scheme",
//             "/cash-credit-loan", "/Janaseva-Start-Up-(MSME)Finance",
//             "/Machinery-Loan", "/gold-loan", "/Loan-Against-Life-Insurance-Policies",
//             "/hypothecation-loan", "/Property-Loan-Builder-Finance",
//             "/trade-pack-loan", "/ProSelf-Loan", "/Janaseva-Saral-Karj-Yojana",
//             "/Janaseva-Gharkul-Loan-Scheme",
//             "/Housing-Loan-under-CRE", "/Hospital-Educational-Institute-Loan",
//             "/Janaseva-Home-Decore",
//             "/Janaseva-Gharkul-Top-Up", "/Government-Secured-Loan", "/Loan-Against-FD-FDTL",
//             "/New-four-Wheeler-Loan", "/Janaseva-Saral-Overdraft-Loan-Scheme",
//             "/Two-Wheeler-Loan", "/Rent-Discounting",
//             "/Resale-4-Wheeler",
//             "/Janaseva-Educational-Secured-Loan",
//             "/Education-loan-for-Coaching", "/Janvikas-Loan-Scheme",
//             "/Unsecured-Education-Loan", "/Consumer-Durable", "/Consumer-Loan", "/Personal-Loan-Scheme", "/Group-Loan"
...
//                                             Commercial Loans <IoIosArrowForward />
//                                         </Link>
...
//                                                 </ul>
//                                             </li>
//                                             <li><Link to="/Hospital-Educational-Institute-Loan">Hospital/Educational Institute Loan </Link></li>
//                                             <li><Link to="/Janaseva-Start-Up-(MSME)Finance">Start Up (MSME) Finance</Link></li>
//                                             <li><Link to="/Janaseva-Solar-Scheme">Janaseva Solar Scheme</Link></li>

//                                             <li><Link to="/Janaseva-Saral-Karj-Yojana">Janaseva Saral Karj Yojana</Link></li>
...
//                                         <li className="dropdown">
//                                             <Link to="/#" className="flex items-center justify-between w-full">
//                                                 Vehicle Loans <IoIosArrowForward />
//                                             </Link>
...
//                                         <li className="dropdown">
//                                             <Link to="/#" className="flex items-center justify-between w-full">
//                                                 Personal Loans <IoIosArrowForward />
//                                             </Link>
...
//                                         <li className="dropdown">
//                                             <Link to="/#" className="flex items-center justify-between w-full">
//                                                 Education Loans <IoIosArrowForward />
//                                             </Link>
...
//                                         <li className="dropdown">
//                                             <Link to="/#" className="flex items-center justify-between w-full">
//                                                 Housing Loans <IoIosArrowForward />
//                                             </Link>
...
//                             </li>
//                             <li>
//                                 <Link to="/about" onClick={() => setmobile(false)}>Deposits</Link>
//                             </li>
//                             <li className="dropdown">
//                                 <Link to="#" className={servicesDrop ? "expanded" : ""}>Services
//                                     <button aria-label="dropdown toggler" className={servicesDrop ? "expanded" : ""} onClick={() => setservicesDrop(servicesDrop ? false : true)}>
