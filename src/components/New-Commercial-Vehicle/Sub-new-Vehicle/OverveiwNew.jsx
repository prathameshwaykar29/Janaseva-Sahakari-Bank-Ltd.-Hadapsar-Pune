...
const loanHighlights = [
  [<FaPercentage />, "10%", "Rate of Interest"],
  [<FaRupeeSign />, "₹50.00 Lakh", "Maximum Loan Limit"],
  [<FaCar />, "15% (On Road Cost)", "Margin"],
  [<FaCalendarAlt />, "Upto 25 lakh -60M Above 25 lakh- 84M", "Loan Period"],
  [<FaCoins />, "2.50%", "Shares"],
  [<FaFileInvoiceDollar />, "1.00%", "Processing Fee"],
  [<FaUserFriends />, "1 Required", "Guarantor"],
];

export default function OverveiwNew() {
  return (
    <CardSection>
