...
const eligibilityData = {
  ...
  vehicleConditions: {
    title: "Commercial Vehicle Loan Conditions",
    icon: FaBuilding,
    items: [
      ["Loan Purpose", "Purchase of New Commercial Vehicle"],
      ["Maximum Loan", "Up to ₹50.00 Lakh"],
      ["Margin", "15% of On-Road Cost"],
      ["Loan Period", "Up to 60 Months (≤ ₹25L) / 84 Months (> ₹25L)"],
...
export default function EligibiltyNew() {
