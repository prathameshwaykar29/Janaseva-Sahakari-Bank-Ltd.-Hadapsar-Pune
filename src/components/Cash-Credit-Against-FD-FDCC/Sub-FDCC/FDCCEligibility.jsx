...
const gharkul_eligibilityData = {
  conditions: {
    icon: FaBuilding,
  title: "Cash Credit Against FD (FDCC) Eligibility",
    items: [
      ...
      ["Interest Rate", "FD Rate + 2% (0.50% extra for Third Party FD)"],
      ["Margin", "10%"],
      ["Loan Period", "Due date of Fixed Deposit"],
      ["Guarantor", "NA"],
      ["Shares", "NA"],
      ["Processing Fee", "NA"],
    ],
...
export default function FDCCEligibility() {
  return (
