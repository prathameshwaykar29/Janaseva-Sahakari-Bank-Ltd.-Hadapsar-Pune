...
import bikeImg from "../../../assets/images/Loan/Fdcc.png";
...
<p className="text-gray-600 text-lg leading-relaxed mb-4">
    Avail flexible cash credit facility against your Fixed Deposit without breaking it.
</p>
