...
import bikeImg from "../../../assets/images/Loan/Aboard.png";

const translations = {
  en: {
    title: "Unsecured Education Loan",
    subtitle: "Higher Education Abroad",
    desc: "Loan facility for students pursuing higher education in India or abroad without collateral security.",
    applyBtn: "Apply Now",
    calcBtn: "Calculate EMI",
    loanName: "Unsecured Education Loan",
  },
  mr: {
    title: "बिनतारण शिक्षण कर्ज",
    subtitle: "परदेशातील उच्च शिक्षणासाठी",
    desc: "भारतात किंवा परदेशात उच्च शिक्षण घेणाऱ्या विद्यार्थ्यांसाठी तारणाशिवाय कर्ज सुविधा.",
    applyBtn: "अर्ज करा",
    calcBtn: "ईएमआय मोजा",
    loanName: "Unsecured Education Loan",
  },
