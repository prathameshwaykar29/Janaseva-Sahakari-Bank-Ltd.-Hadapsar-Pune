  ...
  General: [
    {
      ...
      items: [
        ...
        { name: "Admission Letter from Institute with Fees Schedule", note: "Mandatory" },
        { name: "Mark Sheets / Pass Certificates", note: "Mandatory" },
        { name: "Recognition of Institute by competent Authority", note: "Required" },
...
export default function UnsecuredEducationdoc() {
