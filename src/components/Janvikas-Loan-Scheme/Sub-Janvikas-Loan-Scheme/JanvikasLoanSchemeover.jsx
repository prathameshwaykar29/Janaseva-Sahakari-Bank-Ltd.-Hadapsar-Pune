...
const janvikas_loanHighlights = [
  [<FaPercentage />, "12.00%", "Rate of Interest"],
  [<FaRupeeSign />, "Rs. 1 Lakh", "Maximum Loan Limit"],
  [<FaPercentage />, "NA", "Margin"],
...
export default function JanvikasLoanSchemeover() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {janvikas_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
