...
const janvikas_faqs = [
  { q: "What is the Janvikas Loan?", a: "A small personal loan up to Rs. 1 lakh for any personal purpose." },
  { q: "What is the interest rate?", a: "12.00% per annum." },
  { q: "What is the repayment period?", a: "48 months." },
  { q: "Is any collateral required?", a: "No." },
...
export default function JanvikasLoanSchemefaq() {
