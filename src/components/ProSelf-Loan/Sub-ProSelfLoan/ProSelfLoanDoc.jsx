...
const homeDecore_loanDocsData = {
  General: [
    {
      icon: FaIdCard,
      cat: "KYC & Professional Documents",
      items: [
        { name: "Photographs – 3 Copies", note: "Mandatory" },
        { name: "PAN Card", note: "Mandatory" },
        { name: "Aadhaar Card", note: "Mandatory" },
        { name: "Professional Registration Certificate (Medical Council, Bar Council etc.)", note: "Mandatory" },
        { name: "Practice / Office Address Proof", note: "Required" },
    ...
    },
    {
     ...
     cat: "Financial Documents",
      items: [
        { name: "Last 3 Years IT Returns with Computation", note: "Mandatory" },
        { name: "Last 12 Months Bank Statement", note: "Mandatory" },
        { name: "Estimated Income Statement", note: "Required" },
        { name: "Quotation for Office / Furniture Purchase", note: "Mandatory" },
...
export default function ProSelfLoanDoc() {
