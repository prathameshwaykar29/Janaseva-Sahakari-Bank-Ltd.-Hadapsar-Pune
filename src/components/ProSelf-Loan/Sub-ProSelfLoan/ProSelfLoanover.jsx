...
const proself_loanHighlights = [
  [<FaPercentage />, "10.00%", "Rate of Interest"],
  [<FaRupeeSign />, "TL Rs.10L | CC Rs.2L", "Maximum Loan Limit"],
  [<FaPercentage />, "Term Loan 20% | Cash Credit 25%", "Margin"],
...
export default function ProSelfLoanover() {
  return (
    <CardSection>
      <SectionTitle>Loan Glance</SectionTitle>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {proself_loanHighlights.map(([icon, val, lbl]) => (
          <div
            key={lbl}
            className="
