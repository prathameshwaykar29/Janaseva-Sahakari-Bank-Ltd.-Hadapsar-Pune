...
const govtSecured_faqs = [
  { q: "What is the Government Secured Loan?", a: "A loan against government securities such as NSC, KVP, or government bonds." },
  { q: "What is the interest rate?", a: "11.00% per annum." },
  { q: "What is the loan period?", a: "Up to the due date of the pledged security." },
...
export default function GSlfaq() {
  ...
  return (
    <section className="p-6">
      ...
      <div className="flex flex-col gap-2">
        {govtSecured_faqs.map((faq, index) => (
          <FaqItem
            key={index}
            faq={faq}
