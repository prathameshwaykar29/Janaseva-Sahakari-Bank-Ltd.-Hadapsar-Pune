...
import GSlover from "./GSlover.jsx";
import GSlbenifits from "./GSlbenifits.jsx";
import GSleligibility from "./GSleligibility.jsx";
import GSldoc from "./GSldoc.jsx";
import GSlfaq from "./GSlfaq.jsx";
...
const TAB_COMPONENTS = {
  "Overview": <GSlover />,
  "Features & Benefits": <GSlbenifits />,
  "Eligibility": <GSleligibility />,
  "Documents": <GSldoc />,
  "FAQs": <GSlfaq />
};

export default function MainGSL() {
